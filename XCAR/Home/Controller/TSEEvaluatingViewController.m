...
@interface TSEEvaluatingViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation TSEEvaluatingViewController
...
//        TSELog(@"carnews------/n%@", json);
        ...
        NSArray *evaNewsArr = [TSEHomeViewNews objectArrayWithKeyValuesArray:json[@"newsList"]];
        
        // 创建frame模型对象
        NSMutableArray *newsArray = [NSMutableArray array];
        for (TSEHomeViewNews *news in evaNewsArr) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    TSEHomeViewNewsCellFrame *lnf = self.evaluatingNewsFrame[indexPath.row];
    return lnf.cellHeight;
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    TSEHomeViewNewsCellFrame *f = self.evaluatingNewsFrame[indexPath.row];
